...
using BookManagement.Data.MockData;
...
namespace BookManagement.Test
{
    public class BooksControllerTest
    {
        ...
        public void DetailsUnitTest(string validGuid, string invalidGuid)
        {
            ...
            //act
            var result = controller.DetailsStr(null);

            //assert
            var viewResult = Assert.IsType<ViewResult>(result);
            var viewResultValue = Assert.IsAssignableFrom<Book>(viewResult.ViewData.Model);
            Assert.NotEqual("Managing Oneself", viewResultValue.Title);
        ...
        [Theory]
        [InlineData("ab2bd817-98cd-4cf3-a80a-53ea0cd9c213")]
